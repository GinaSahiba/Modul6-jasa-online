...
import id.ac.polbeng.amandaagungpermata.p8pro22.activities.EditProfileActivity
import id.ac.polbeng.amandaagungpermata.p8pro22.activities.LoginActivity
...
import id.ac.polbeng.amandaagungpermata.p8pro22.services.UserService
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(user != null) {
            ...
            view.tvWaktuSesi.text = titikDua + session.getExpiredTime()
        }
